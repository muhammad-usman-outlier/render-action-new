...
export function getSdk(client, withWrapper = defaultWrapper) {
  return {
    Deploy(variables, requestHeaders) {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request(DeployDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'Deploy'
    ...
    Deploys(variables, requestHeaders) {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request(DeploysDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'Deploys'
    ...
    PullRequestServers(variables, requestHeaders) {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request(PullRequestServersDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'PullRequestServers'
    ...
    SignIn(variables, requestHeaders) {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request(SignInDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'SignIn'
